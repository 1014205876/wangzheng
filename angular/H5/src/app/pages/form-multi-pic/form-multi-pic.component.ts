...
@Component({
  selector: 'app-form-multi-pic',
  templateUrl: './form-multi-pic.component.html',
  styleUrls: ['./form-multi-pic.component.css']
})
export class FormMultiPicComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedroute.queryParams.subscribe(res=>{
      this.pageState=res;
      if(this.pageState.imgUrl){
        this.imgList=JSON.parse(this.pageState.imgUrl);
      }
    })
  }
  previewImg(input) {
