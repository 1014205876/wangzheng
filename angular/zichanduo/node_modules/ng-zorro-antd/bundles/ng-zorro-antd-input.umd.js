(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('ng-zorro-antd/core'), require('@angular/forms'), require('@angular/common'), require('ng-zorro-antd/icon'), require('@angular/cdk/platform'), require('rxjs'), require('rxjs/operators')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/input', ['exports', '@angular/core', 'ng-zorro-antd/core', '@angular/forms', '@angular/common', 'ng-zorro-antd/icon', '@angular/cdk/platform', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].input = {}), global.ng.core, global['ng-zorro-antd'].core, global.ng.forms, global.ng.common, global['ng-zorro-antd'].icon, global.ng.cdk.platform, global.rxjs, global.rxjs.operators));
}(this, function (exports, core, core$1, forms, common, icon, platform, rxjs, operators) { 'use strict';
    ...
    var NzInputModule = /** @class */ (function () {
        ...
        NzInputModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [common.CommonModule, forms.FormsModule, icon.NzIconModule, platform.PlatformModule, core$1.NzAddOnModule]
                    },] }
        ];
