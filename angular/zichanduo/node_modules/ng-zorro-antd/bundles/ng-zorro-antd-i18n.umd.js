(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('@angular/common'), require('date-fns/format'), require('date-fns/get_iso_week'), require('date-fns/parse')) :
    typeof define === 'function' && define.amd ? define('ng-zorro-antd/i18n', ['exports', '@angular/core', 'rxjs', '@angular/common', 'date-fns/format', 'date-fns/get_iso_week', 'date-fns/parse'], factory) :
    (global = global || self, factory((global['ng-zorro-antd'] = global['ng-zorro-antd'] || {}, global['ng-zorro-antd'].i18n = {}), global.ng.core, global.rxjs, global.ng.common, global.fnsFormat, global.fnsGetISOWeek, global.fnsParse));
}(this, function (exports, core, rxjs, common, fnsFormat, fnsGetISOWeek, fnsParse) { 'use strict';
